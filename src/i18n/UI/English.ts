export const English = {
  ...
  pageDescriptions: {
    ...
    signUp:
      "Provider your email and create a password to signup to search services or post services on TodoServis.",
    ...
    terms:
      "Review our Terms and Conditions. Please note, the translations are provided as a courtesy, the official binding terms are in Spanish.",
    privacy:
  ...
  productCategoryInfo: {
    categories: [
      ...
      },
      {
        ...
        description: "",
        ariaLabel: "Foreign Language",
        id: "3",
      },
      { name: "Holiday", description: "", ariaLabel: "Holiday", id: "4" },
      { name: "Math", description: "", ariaLabel: "", id: "5" },
      { name: "Science", description: "", ariaLabel: "Science", id: "6" },
      {
        name: "Social Studies",
        description: "",
      ...
      { name: "Specialty", description: "", ariaLabel: "Specialty", id: "8" },
