export const French = {
  ...
  pageDescriptions: {
    ...
    signUp:
      "Fournissez votre e-mail et créez un mot de passe pour vous inscrire pour rechercher des services ou publier des services sur TodoServis.",
    login:
      "Entrez votre email et votre mot de passe pour vous connecter à TodoServis.",
    ...
    terms:
      "Consultez nos termes et conditions. Remarque : les traductions sont fournies à titre gracieux, les termes officiels contraignants sont en espagnol.",
    privacy:
    ...
    about:
      "Découvrez l'histoire de TodoServis – qui nous sommes, notre mission et notre passion de contribuer à révolutionner la façon dont les particuliers et les entreprises trouvent et fournissent des services. Découvrez notre équipe et les valeurs qui nous animent. Rejoignez-nous dans notre voyage !",
    impact:
      "Découvrez l’impact significatif de TodoServis. Découvrez comment nous faisons la différence et apprenez-en davantage sur nos projets et nos contributions à un changement positif.",
    fullPost:
    ...
    categories: [
      {
        name: "Jardinage",
        description:
          "Obtenez de l'aide pour votre jardin et votre aménagement paysager.",
        ariaLabel: "Jardinage",
        id: "1",
      },
      {
        name: "Construction",
        description:
          "Nouvelles constructions, ajouts ou services de réparation",
        ariaLabel: "Construction",
        id: "3",
      },
      {
        name: "Beauté",
        description: "Salons, barbiers et autres soins personnels.",
        ariaLabel: "Beauté",
        id: "2",
      },
      {
      ...
      },
      {
        ...
        ariaLabel: "Ordinateur",
        id: "4",
      },
      {
        name: "Créative",
        description: "Services créatifs",
        ariaLabel: "Créative",
        id: "6",
      },
      {
