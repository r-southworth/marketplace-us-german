export const Spanish = {
  ...
  pageDescriptions: {
    ...
    signUp:
      "Proporcione su correo electrónico y cree una contraseña para registrarse para buscar servicios o publicar servicios en TodoServis.",
    login:
      "Ingrese su correo electrónico y contraseña para iniciar sesión en TodoServis.",
    ...
    about:
      "Descubra la historia detrás de TodoServis: quiénes somos, nuestra misión y nuestra pasión por ayudar a revolucionar la forma en que las personas y las empresas encuentran y brindan servicios. Conozca nuestro equipo y los valores que nos impulsan. ¡Únase a nosotros en nuestro viaje!",
    impact:
      "Explore el impacto significativo de TodoServis. Descubra cómo estamos marcando la diferencia y obtenga más información sobre nuestros proyectos y nuestras contribuciones al cambio positivo.",
    fullPost:
  ...
  productCategoryInfo: {
    categories: [
      {
        name: "Jardinería",
        description: "Obtenga ayuda con su jardín y sus áreas verdes.",
        ariaLabel: "Jardinería",
        id: "1",
      },
      {
        name: "Construcción",
        description: "Nueva construcción, adiciones o servicios de reparación",
        ariaLabel: "Construcción",
        id: "3",
      },
      {
        name: "Belleza",
        description: "Salones, Barberias, y otros cuidados personales.",
        ariaLabel: "Belleza",
        id: "2",
      },
      {
        ...
        ariaLabel: "Automotriz",
        id: "5",
      },
      {
        name: "Computación",
        description: "Reparación y servicios de computadoras",
        ariaLabel: "Computación",
        id: "4",
      },
      {
        name: "Artes",
